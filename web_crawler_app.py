...
def detect_donation_platform(base_url, soup):
    platforms = {
        ...
        'givemsmart': ['givemsmart.com'],
        'bloomerang': ['bloomerang.co'],
        'kindful': ['kindful.com'],
        'raisersedge': ['raisersedge.com'],
        'blackbaud nxt': ['blackbaud.com'],
        'blackbaud raisers edge': ['raisersedge.com'],
        'everyaction': ['everyaction.com'],
        'give butter': ['givebutter.com'],
        'neon': ['neoncrm.com'],
        'salsa': ['salsalabs.com'],
        'salesforce': ['salesforce.com'],
        'virtuous': ['virtuouscrm.com'],
        ...
        if any(k in (a.get_text().lower() + a['href'].lower()) for k in ["donate", "support", "give"]):
            try:
                ...
                for p, domains in platforms.items():
                    if any(domain in txt or p in txt for domain in domains):
